...
def activity_report(
    ...
    for role_class in permissions:
        ...
        # Get most recent timestamps for each member of augroup and save it in
        # a dictionary.
        actions_by_user = {
            e['name']: role.recent_stamps(e['name']) for e in candidates
        }
        ...
        # TODO(lfaraone): Consider using this to generate activity statistics
        recently_active = []
